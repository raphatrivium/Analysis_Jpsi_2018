...
RooRealVar alpha( "alpha", "tail shift", 2.10, 0.30, 2.30);
RooRealVar npow( "npow", "power order", 0.40, 0.10, 12.50);
RooRealVar lambda1( "lambda1", "slope", 2.0, 0.1, 6.8);
...
//--------------------------------------------------
RooRealVar bkgExpo1_frac("bkgExpo1_frac", "fraction of expo1", 400, 100, 10000);
...
RooRealVar signal_frac("signal_frac","fraction of signal",1620, 1100, 3110);
...
//L E G E N D
//---------------------------------------------
TLegend *leg1 = new TLegend(0.15,0.80,0.26,0.70);
...
//----------------------------------------
Jpsi_teste_canvas->SaveAs("/eos/user/r/ragomesd/analysis_2018/Jpsi_CB_Gauss_2expo.png");
